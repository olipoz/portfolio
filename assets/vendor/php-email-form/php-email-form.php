...
if ( version_compare(phpversion(), '5.5.0', '<') ) {
  die('La version 5.5.0 et plus de PHP est requise. Votre version de PHP est : ' . phpversion());
}
...
class PHP_Email_Form {
  ...
  public $error_msg = array(
    'invalid_to_email' => 'L\'e-mail à (adresse e-mail de réception) est vide ou invalide !',
    'invalid_from_name' => 'Le nom est vide !',
    'invalid_from_email' => 'L\'Email est vide ou invalide !',
    'invalid_subject' => 'Le sujet est trop court ou vide !',
    'short' => 'est trop court ou vide !',
    'ajax_error' => 'Désolé, la requête doit être un POST Ajax !',
    'invalid_attachment_extension' => 'L\'extension de fichier n\'est pas autorisée, veuillez choisir :',
    'invalid_attachment_size' => 'La taille maximale autorisée des pièces jointes est de :'
  );
